...
# the reputation of user Atabay(user1) who did the report is 1 
...
if exists("1591057377597.png"):
    ...
    wheel(WHEEL_DOWN,2)
    wait(3)
    doubleClick("1591129315316.png")
#after this user reputation of Atabay will increase from 1 to 2
